...
'Interleave Load: Masked Load'                  :['vldcb[1-8]in1_v_[iu][136][624]_m$', 'common_tail_1.c', 'common_tail_x.c'],
...
'Indexed Load: Unmasked Load'                   :['vgldcb[1-8]_v_[iu][136][624]$', 'common_tail_1.c', 'common_tail_x.c'],
'Indexed Load: Masked Load'                     :['vgldcb[1-8]_v_[iu][136][624]_m$', 'common_tail_1.c', 'common_tail_x.c'],
...
'IIR: Signed Fract Clear Dotiir'                :['vsrdotiircq_v_i32_d[1-8]s[1-8]$', 'common_tail_1.c', 'common_tail_x.c'],
'IIR: Signed Fract Dotiir'                      :['vsrdotiirq_v_i32_d[1-8]s[1-8]$', 'common_tail_1.c', 'common_tail_x.c'],
'IIR: Unsigned Fract Clear Dotiir'              :['vsrdotiircu_v_i32_d[1-8]s[1-8]$', 'common_tail_1.c', 'common_tail_x.c'],
'IIR: Unsigned Fract Dotiir'                    :['vsrdotiiru_v_i32_d[1-8]s[1-8]$', 'common_tail_1.c', 'common_tail_x.c'],
}
