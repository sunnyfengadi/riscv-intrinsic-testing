...
VALUE_MAP={
    ...
    'bool8_t':                {'mask':gen_mask(8),'src_mask':gen_mask(8),'dst_mask':gen_mask(8),'a':gen_num(16,8),'b':gen_num(16,8),'maskoff':gen_num(16,8)},
    'bool8x2_t':              {'mask':gen_mask(16),'src_mask':gen_mask(16),'dst_mask':gen_mask(16),'a':gen_num(16,8*2),'b':gen_num(16,8*2),'maskoff':gen_num(16,8*2)},
    'bool16_t':               {'mask':gen_mask(16),'src_mask':gen_mask(16),'dst_mask':gen_mask(16),'a':gen_num(16,16),'b':gen_num(16,16),'maskoff':gen_num(16,16)},
    'bool16x2_t':             {'mask':gen_mask(32),'src_mask':gen_mask(32),'dst_mask':gen_mask(32),'a':gen_num(16,16*2),'b':gen_num(16,16*2),'maskoff':gen_num(16,16*2)},
    'bool32_t':               {'mask':gen_mask(32),'src_mask':gen_mask(32),'dst_mask':gen_mask(32),'a':gen_num(16,32),'b':gen_num(16,32),'maskoff':gen_num(16,32)},
    'bool32x2_t':             {'mask':gen_mask(64),'src_mask':gen_mask(64),'dst_mask':gen_mask(64),'a':gen_num(16,32*2),'b':gen_num(16,32*2),'maskoff':gen_num(16,32*2)},
