...
int main(void) {
    ...
    result0 = vwsrl_ax_i64(result0, b1, ACCUM0);
    result0 = vwsrl_ai_i64(result0, 8, ACCUM0);
    result0 = vwsrl_as_i64(result0, ACCUM0);
    result0 = vwsrl_av_i64_m(mask, maskoff, result0, b, ACCUM0);
    result0 = vwsrl_ax_i64_m(mask, maskoff, result0, b1, ACCUM0);
    result0 = vwsrl_ai_i64_m(mask, maskoff, result0, 8, ACCUM0);
    result0 = vwsrl_as_i64_m(mask, maskoff, result0, ACCUM0);
    result0 = vcsl_i_i64(result0, 8, ACCUM0);
    final_result0 = vcsr_i_i64(result0, 8, ACCUM0);

    //Get Intrinsic result
    result1 = vwsrl_av_i64(a, b, ACCUM1);
    result1 = vwsrl_ax_i64(result1, b1, ACCUM1);
    result1 = vwsrl_ai_i64(result1, 8, ACCUM1);
    result1 = vwsrl_as_i64(result1, ACCUM1);
    result1 = vwsrl_av_i64_m(mask, maskoff, result1, b, ACCUM1);
    result1 = vwsrl_ax_i64_m(mask, maskoff, result1, b1, ACCUM1);
    result1 = vwsrl_ai_i64_m(mask, maskoff, result1, 8, ACCUM1);
    result1 = vwsrl_as_i64_m(mask, maskoff, result1, ACCUM1);
    result1 = vcsl_i_i64(result1, 8, ACCUM1);
    final_result1 = vcsr_i_i64(result1, 8, ACCUM1);

    //Get Intrinsic result
    result2 = vwsrl_av_i64(a, b, ACCUM2);
    result2 = vwsrl_ax_i64(result2, b1, ACCUM2);
    result2 = vwsrl_ai_i64(result2, 8, ACCUM2);
    result2 = vwsrl_as_i64(result2, ACCUM2);
    result2 = vwsrl_av_i64_m(mask, maskoff, result2, b, ACCUM2);
    result2 = vwsrl_ax_i64_m(mask, maskoff, result2, b1, ACCUM2);
    result2 = vwsrl_ai_i64_m(mask, maskoff, result2, 8, ACCUM2);
    result2 = vwsrl_as_i64_m(mask, maskoff, result2, ACCUM2);
    result2 = vcsl_i_i64(result2, 8, ACCUM2);
    final_result2 = vcsr_i_i64(result2, 8, ACCUM2);

    //Get Intrinsic result
    result3 = vwsrl_av_i64(a, b, ACCUM3);
    result3 = vwsrl_ax_i64(result3, b1, ACCUM3);
    result3 = vwsrl_ai_i64(result3, 8, ACCUM3);
    result3 = vwsrl_as_i64(result3, ACCUM3);
    result3 = vwsrl_av_i64_m(mask, maskoff, result3, b, ACCUM3);
    result3 = vwsrl_ax_i64_m(mask, maskoff, result3, b1, ACCUM3);
    result3 = vwsrl_ai_i64_m(mask, maskoff, result3, 8, ACCUM3);
    result3 = vwsrl_as_i64_m(mask, maskoff, result3, ACCUM3);
    result3 = vcsl_i_i64(result3, 8, ACCUM3);
    final_result3 = vcsr_i_i64(result3, 8, ACCUM3);

    //Get Intrinsic result
    result4 = vwsrl_av_i64(a, b, ACCUM4);
    result4 = vwsrl_ax_i64(result4, b1, ACCUM4);
    result4 = vwsrl_ai_i64(result4, 8, ACCUM4);
    result4 = vwsrl_as_i64(result4, ACCUM4);
    result4 = vwsrl_av_i64_m(mask, maskoff, result4, b, ACCUM4);
    result4 = vwsrl_ax_i64_m(mask, maskoff, result4, b1, ACCUM4);
    result4 = vwsrl_ai_i64_m(mask, maskoff, result4, 8, ACCUM4);
    result4 = vwsrl_as_i64_m(mask, maskoff, result4, ACCUM4);
    result4 = vcsl_i_i64(result4, 8, ACCUM4);
    final_result4 = vcsr_i_i64(result4, 8, ACCUM4);

    //Get Intrinsic result
    result5 = vwsrl_av_i64(a, b, ACCUM5);
    result5 = vwsrl_ax_i64(result5, b1, ACCUM5);
    result5 = vwsrl_ai_i64(result5, 8, ACCUM5);
    result5 = vwsrl_as_i64(result5, ACCUM5);
    result5 = vwsrl_av_i64_m(mask, maskoff, result5, b, ACCUM5);
    result5 = vwsrl_ax_i64_m(mask, maskoff, result5, b1, ACCUM5);
    result5 = vwsrl_ai_i64_m(mask, maskoff, result5, 8, ACCUM5);
    result5 = vwsrl_as_i64_m(mask, maskoff, result5, ACCUM5);
    result5 = vcsl_i_i64(result5, 8, ACCUM5);
    final_result5 = vcsr_i_i64(result5, 8, ACCUM5);

    //Get Intrinsic result
    result6 = vwsrl_av_i64(a, b, ACCUM6);
    result6 = vwsrl_ax_i64(result6, b1, ACCUM6);
    result6 = vwsrl_ai_i64(result6, 8, ACCUM6);
    result6 = vwsrl_as_i64(result6, ACCUM6);
    result6 = vwsrl_av_i64_m(mask, maskoff, result6, b, ACCUM6);
    result6 = vwsrl_ax_i64_m(mask, maskoff, result6, b1, ACCUM6);
    result6 = vwsrl_ai_i64_m(mask, maskoff, result6, 8, ACCUM6);
    result6 = vwsrl_as_i64_m(mask, maskoff, result6, ACCUM6);
    result6 = vcsl_i_i64(result6, 8, ACCUM6);
    final_result6 = vcsr_i_i64(result6, 8, ACCUM6);

    //Get Intrinsic result
    result7 = vwsrl_av_i64(a, b, ACCUM7);
    result7 = vwsrl_ax_i64(result7, b1, ACCUM7);
    result7 = vwsrl_ai_i64(result7, 8, ACCUM7);
    result7 = vwsrl_as_i64(result7, ACCUM7);
    result7 = vwsrl_av_i64_m(mask, maskoff, result7, b, ACCUM7);
    result7 = vwsrl_ax_i64_m(mask, maskoff, result7, b1, ACCUM7);
    result7 = vwsrl_ai_i64_m(mask, maskoff, result7, 8, ACCUM7);
    result7 = vwsrl_as_i64_m(mask, maskoff, result7, ACCUM7);
    result7 = vcsl_i_i64(result7, 8, ACCUM7);
    final_result7 = vcsr_i_i64(result7, 8, ACCUM7);
