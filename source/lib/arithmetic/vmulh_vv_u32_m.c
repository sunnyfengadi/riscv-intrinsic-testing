...
void vmulh_vv_u32_m_golden(uint64_t *mask,uint32_t *maskoff,uint32_t *a,uint32_t *b,uint32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vmulh_vv_u32_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vmulh_vv_u32_m(mask,maskoff,a,b);
