...
void vsmul_vv_i16_m_golden(uint64_t *mask,int16_t *maskoff,int16_t *a,int16_t *b,int16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsmul_vv_i16_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vsmul_vv_i16_m(mask,maskoff,a,b);
