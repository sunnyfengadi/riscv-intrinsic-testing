...
void vsmul_vx_i32_m_golden(uint64_t *mask,int32_t *maskoff,int32_t *a,int32_t b,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsmul_vx_i32_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vsmul_vx_i32_m(mask,maskoff,a,b);
