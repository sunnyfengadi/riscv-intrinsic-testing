...
void vssub_vv_u16_m_golden(uint64_t *mask,uint16_t *maskoff,uint16_t *a,uint16_t *b,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vssub_vv_u16_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vssub_vv_u16_m(mask,maskoff,a,b);
