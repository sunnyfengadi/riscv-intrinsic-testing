...
void vwmul_vv_i32_m_golden(uint64_t *mask,int64_t maskoff[2][8],int32_t *a,int32_t *b,int64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vwmul_vv_i32_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vwmul_vv_i32_m(mask,maskoff,a,b);
