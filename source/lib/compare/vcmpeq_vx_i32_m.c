...
void vcmpeq_vx_i32_m_golden(uint64_t *mask, int32_t *a, int32_t *b, int32_t *c, int32_t *d, int32_t *exp_result, ) {
...
int main(void) {
    ...
    //Get golden result
    vcmpeq_vx_i32_m_golden(exp_mask,exp_a,exp_b, exp_c, exp_d, exp_result);

    //Get Intrinsic result
    bool16_t compare_result = vcmpeq_vx_i32_m(mask,a,b);
