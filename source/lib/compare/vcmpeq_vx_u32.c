...
void vcmpeq_vx_u32_golden(uint32_t *a, uint32_t b, uint32_t *c, uint32_t *d, uint32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vcmpeq_vx_u32_golden(exp_a,exp_b, exp_c, exp_d, exp_result);

    //Get Intrinsic result
    bool16_t compare_result = vcmpeq_vx_u32(a,b);
