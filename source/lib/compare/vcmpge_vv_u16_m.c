...
void vcmpge_vv_u16_m_golden(uint64_t *mask, uint16_t *a, uint16_t *b, uint16_t *c, uint16_t *d, uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vcmpge_vv_u16_m_golden(exp_mask,exp_a,exp_b, exp_c, exp_d, exp_result);

    //Get Intrinsic result
    bool32_t compare_result = vcmpge_vv_u16_m(mask,a,b);
