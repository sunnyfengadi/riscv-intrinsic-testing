...
void vcmpge_vx_i16_m_golden(uint64_t *mask, int16_t *a, int16_t b, int16_t *c, int16_t *d, int16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vcmpge_vx_i16_m_golden(exp_mask,exp_a,exp_b, exp_c, exp_d, exp_result);

    //Get Intrinsic result
    bool32_t compare_result = vcmpge_vx_i16_m(mask,a,b);
    result = vmerge_vv_i16(compare_result, c, d);
