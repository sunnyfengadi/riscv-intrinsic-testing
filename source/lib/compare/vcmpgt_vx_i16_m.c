...
void vcmpgt_vx_i16_m_golden(bool32_t mask,int16_t *maskoff,int16_t *a,int16_t b,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vcmpgt_vx_i16_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vcmpgt_vx_i16_m(mask,maskoff,a,b);
