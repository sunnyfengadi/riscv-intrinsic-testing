...
void vcmple_vx_i16_golden(int16_t *a, int16_t *b, int16_t *c, int16_t *d, int16_t *exp_result, ) {
...
int main(void) {
    ...
    //Get golden result
    vcmple_vx_i16_golden(exp_a,exp_b, exp_c, exp_d, exp_result);

    //Get Intrinsic result
    bool32_t compare_result = vcmple_vx_i16(a,b);
