...
void vcmpne_vv_u32_m_golden(uint64_t *mask, uint32_t *a, uint32_t *b, uint32_t *c, uint32_t *d, uint32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vcmpne_vv_u32_m_golden(exp_mask,exp_a,exp_b, exp_c, exp_d, exp_result);

    //Get Intrinsic result
    bool16_t compare_result = vcmpne_vv_u32_m(mask,a,b);
