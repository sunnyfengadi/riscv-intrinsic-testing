...
void vclip_wv_i32_m_golden(uint64_t *mask,int32_t *maskoff,int64_t a[2][8],uint32_t *b,int32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vclip_wv_i32_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vclip_wv_i32_m(mask,maskoff,a,b);
