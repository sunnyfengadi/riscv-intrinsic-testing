...
void vextend_v_i32_m_golden(uint64_t *mask,int64_t maskoff[2][8],int32_t *a,int64_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vextend_v_i32_m_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vextend_v_i32_m(mask,maskoff,a);
