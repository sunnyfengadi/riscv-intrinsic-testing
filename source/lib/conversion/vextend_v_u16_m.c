...
void vextend_v_u16_m_golden(uint64_t *mask,uint32_t maskoff[2][16],uint16_t *a,uint32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vextend_v_u16_m_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vextend_v_u16_m(mask,maskoff,a);
