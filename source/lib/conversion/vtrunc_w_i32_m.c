...
void vtrunc_w_i32_m_golden(bool16_t mask,int32_t *maskoff,int64_t *a,uint32_t *b,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vtrunc_w_i32_m_golden(exp_mask,exp_maskoff,exp_a,exp_b,exp_result);

    //Get Intrinsic result
    result = vtrunc_w_i32_m(mask,maskoff,a,b);
