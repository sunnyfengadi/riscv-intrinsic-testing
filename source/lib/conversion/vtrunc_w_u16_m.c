...
void vtrunc_w_u16_m_golden(bool32_t mask,uint16_t *maskoff,uint32_t *a,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vtrunc_w_u16_m_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vtrunc_w_u16_m(mask,maskoff,a);
