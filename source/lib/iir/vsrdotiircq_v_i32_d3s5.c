...
void vsrdotiircq_v_i32_d3s5_golden(int32_t *base,int32_t a[5][16],int32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsrdotiircq_v_i32_d3s5_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircq_v_i32_d3s5(base,a);
