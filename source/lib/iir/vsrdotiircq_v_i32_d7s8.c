...
void vsrdotiircq_v_i32_d7s8_golden(int32_t *base,int32_t a[8][16],int32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    data_init_matrix(a, exp_a, 16, 8, 0xffffffff);
    ...
    //Get golden result
    vsrdotiircq_v_i32_d7s8_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircq_v_i32_d7s8(base,a);
