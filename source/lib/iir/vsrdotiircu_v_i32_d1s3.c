...
void vsrdotiircu_v_i32_d1s3_golden(int32_t *base,int32_t a[3][16],int32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsrdotiircu_v_i32_d1s3_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircu_v_i32_d1s3(base,a);
