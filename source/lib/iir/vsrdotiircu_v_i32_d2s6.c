...
void vsrdotiircu_v_i32_d2s6_golden(int32_t *base,int32_t a[6][16],int32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsrdotiircu_v_i32_d2s6_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircu_v_i32_d2s6(base,a);
