...
void vsrdotiircu_v_i32_d4s8_golden(int32_t *base,int32_t a[8][16],int32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsrdotiircu_v_i32_d4s8_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircu_v_i32_d4s8(base,a);
