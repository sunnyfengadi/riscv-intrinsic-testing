...
void vsrdotiircu_v_i32_d5s1_golden(int32_t base[],int32_t *a,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsrdotiircu_v_i32_d5s1_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircu_v_i32_d5s1(base,a);
