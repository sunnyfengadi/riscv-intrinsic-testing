...
void vsrdotiircu_v_i32_d7s2_golden(int32_t base[],int32_t *a,int32_t *exp_result) {
...
int main(void) {
    ...
    data_init(a, exp_a, 16*2, 0xffffffff);
    ...
    //Get golden result
    vsrdotiircu_v_i32_d7s2_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircu_v_i32_d7s2(base,a);
