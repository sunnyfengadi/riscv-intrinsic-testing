...
void vsrdotiircu_v_i32_d7s7_golden(int32_t *base,int32_t a[7][16],int32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    data_init_matrix(a, exp_a, 16, 7, 0xffffffff);
    ...
    //Get golden result
    vsrdotiircu_v_i32_d7s7_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiircu_v_i32_d7s7(base,a);
