...
void vsrdotiirq_v_i32_d8s3_golden(int32_t *base,int32_t a[3][16],int32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsrdotiirq_v_i32_d8s3_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiirq_v_i32_d8s3(base,a);
