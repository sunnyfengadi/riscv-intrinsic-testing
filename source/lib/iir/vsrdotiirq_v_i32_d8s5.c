...
void vsrdotiirq_v_i32_d8s5_golden(int32_t base[],int32_t *a,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsrdotiirq_v_i32_d8s5_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiirq_v_i32_d8s5(base,a);
