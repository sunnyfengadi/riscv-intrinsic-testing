...
void vsrdotiiru_v_i32_d1s4_golden(int32_t *base,int32_t a[4][16],int32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsrdotiiru_v_i32_d1s4_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiiru_v_i32_d1s4(base,a);
