...
void vsrdotiiru_v_i32_d8s8_golden(int32_t *base,int32_t a[8][16],int32_t exp_result[][ELE_NUM]) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsrdotiiru_v_i32_d8s8_golden(exp_base,exp_a,exp_result);

    //Get Intrinsic result
    result = vsrdotiiru_v_i32_d8s8(base,a);
