...
void vgldcb1_v_u16_golden(uint16_t *base,int16_t *index,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb1_v_u16_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb1_v_u16(base,index);
