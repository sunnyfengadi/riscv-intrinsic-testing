...
void vgldcb1_v_u16_m_golden(bool32_t *mask,uint16_t maskoff,uint16_t *base,int16_t index,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb1_v_u16_m_golden(exp_mask,exp_maskoff,exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb1_v_u16_m(mask,maskoff,base,index);
