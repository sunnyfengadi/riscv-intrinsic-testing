...
void vgldcb1_v_u64_golden(uint64_t *base,int64_t index,uint64_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb1_v_u64_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb1_v_u64(base,index);
