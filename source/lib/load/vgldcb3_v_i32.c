...
void vgldcb3_v_i32_golden(int32_t *base,int32_t *index,int32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb3_v_i32_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb3_v_i32(base,index);
