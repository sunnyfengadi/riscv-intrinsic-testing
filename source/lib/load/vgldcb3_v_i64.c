...
void vgldcb3_v_i64_golden(int64_t *base,int64_t *index,int64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb3_v_i64_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb3_v_i64(base,index);
