...
void vgldcb4_v_u64_golden(uint64_t *base,int64_t *index,uint64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb4_v_u64_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb4_v_u64(base,index);
