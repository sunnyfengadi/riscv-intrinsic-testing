...
void vgldcb5_v_i64_m_golden(uint64_t *mask,int64_t maskoff[5][8],int64_t *base,int64_t *index,int64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb5_v_i64_m_golden(exp_mask,exp_maskoff,exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb5_v_i64_m(mask,maskoff,base,index);
