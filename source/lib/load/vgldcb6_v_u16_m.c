...
void vgldcb6_v_u16_m_golden(uint64_t *mask,uint16_t maskoff[6][32],uint16_t *base,int16_t *index,uint16_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb6_v_u16_m_golden(exp_mask,exp_maskoff,exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb6_v_u16_m(mask,maskoff,base,index);
