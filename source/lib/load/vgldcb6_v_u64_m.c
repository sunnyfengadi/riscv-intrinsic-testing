...
void vgldcb6_v_u64_m_golden(bool8_t *mask,uint64_t maskoff,uint64_t *base,int64_t index,uint64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb6_v_u64_m_golden(exp_mask,exp_maskoff,exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb6_v_u64_m(mask,maskoff,base,index);
