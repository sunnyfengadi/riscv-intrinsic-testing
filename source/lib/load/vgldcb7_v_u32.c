...
void vgldcb7_v_u32_golden(uint32_t *base,int32_t index,uint32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb7_v_u32_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb7_v_u32(base,index);
