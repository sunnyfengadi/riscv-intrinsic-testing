...
void vgldcb8_v_i16_golden(int16_t *base,int16_t *index,int16_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb8_v_i16_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb8_v_i16(base,index);
