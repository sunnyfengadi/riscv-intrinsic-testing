...
void vgldcb8_v_i16_m_golden(uint64_t *mask,int16_t maskoff[8][32],int16_t *base,int16_t *index,int16_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb8_v_i16_m_golden(exp_mask,exp_maskoff,exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb8_v_i16_m(mask,maskoff,base,index);
