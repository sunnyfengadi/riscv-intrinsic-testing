...
void vgldcb8_v_i32_m_golden(uint64_t *mask,int32_t maskoff[8][16],int32_t *base,int32_t *index,int32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb8_v_i32_m_golden(exp_mask,exp_maskoff,exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb8_v_i32_m(mask,maskoff,base,index);
