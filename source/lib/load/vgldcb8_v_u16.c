...
void vgldcb8_v_u16_golden(uint16_t *base,int16_t *index,uint16_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vgldcb8_v_u16_golden(exp_base,exp_index,exp_result);

    //Get Intrinsic result
    result = vgldcb8_v_u16(base,index);
