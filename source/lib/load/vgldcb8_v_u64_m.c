...
void vgldcb8_v_u64_m_golden(bool8_t *mask,uint64_t maskoff,uint64_t *base,int64_t index,uint64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    data_init(maskoff, exp_maskoff, 8*8, 0xffffffffffffffff);
