...
void vldcb1in0_v_u64_m_golden(uint64_t *mask,uint64_t *maskoff,uint64_t *base,uint32_t imm,uint64_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vldcb1in0_v_u64_m_golden(exp_mask,exp_maskoff,exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb1in0_v_u64_m(mask,maskoff,base,8);
