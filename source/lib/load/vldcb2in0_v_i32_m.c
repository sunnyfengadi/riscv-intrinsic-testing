...
void vldcb2in0_v_i32_m_golden(uint64_t *mask,int32_t maskoff[2][16],int32_t *base,uint32_t imm,int32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb2in0_v_i32_m_golden(exp_mask,exp_maskoff,exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb2in0_v_i32_m(mask,maskoff,base,8);
