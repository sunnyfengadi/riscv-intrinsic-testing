...
void vldcb2in0_v_i64_golden(int64_t *base,uint32_t imm,int64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb2in0_v_i64_golden(exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb2in0_v_i64(base,8);
