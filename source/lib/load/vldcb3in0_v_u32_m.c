...
void vldcb3in0_v_u32_m_golden(uint64_t *mask,uint32_t maskoff[3][16],uint32_t *base,uint32_t imm,uint32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb3in0_v_u32_m_golden(exp_mask,exp_maskoff,exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb3in0_v_u32_m(mask,maskoff,base,8);
