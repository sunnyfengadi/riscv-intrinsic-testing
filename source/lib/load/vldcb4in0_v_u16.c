...
void vldcb4in0_v_u16_golden(uint16_t *base,uint32_t imm,uint16_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb4in0_v_u16_golden(exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb4in0_v_u16(base,8);
