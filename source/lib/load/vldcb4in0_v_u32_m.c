...
void vldcb4in0_v_u32_m_golden(bool16_t *mask,uint32_t maskoff,uint32_t *base,uint32_t *imm,uint32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb4in0_v_u32_m_golden(exp_mask,exp_maskoff,exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb4in0_v_u32_m(mask,maskoff,base,8);
