...
void vldcb4in0_v_u64_m_golden(uint64_t *mask,uint64_t maskoff[4][8],uint64_t *base,uint32_t imm,uint64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb4in0_v_u64_m_golden(exp_mask,exp_maskoff,exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb4in0_v_u64_m(mask,maskoff,base,8);
