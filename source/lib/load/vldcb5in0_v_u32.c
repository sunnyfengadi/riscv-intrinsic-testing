...
void vldcb5in0_v_u32_golden(uint32_t *base,uint32_t *imm,uint32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb5in0_v_u32_golden(exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb5in0_v_u32(base,8);
