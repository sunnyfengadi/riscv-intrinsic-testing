...
void vldcb6in0_v_i16_m_golden(uint64_t *mask,int16_t maskoff[6][32],int16_t *base,uint32_t imm,int16_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb6in0_v_i16_m_golden(exp_mask,exp_maskoff,exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb6in0_v_i16_m(mask,maskoff,base,8);
