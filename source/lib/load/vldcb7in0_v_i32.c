...
void vldcb7in0_v_i32_golden(int32_t *base,uint32_t imm,int32_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb7in0_v_i32_golden(exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb7in0_v_i32(base,8);
