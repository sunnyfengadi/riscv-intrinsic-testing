...
void vldcb7in0_v_i64_m_golden(uint64_t *mask,int64_t maskoff[7][8],int64_t *base,uint32_t imm,int64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb7in0_v_i64_m_golden(exp_mask,exp_maskoff,exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb7in0_v_i64_m(mask,maskoff,base,8);
