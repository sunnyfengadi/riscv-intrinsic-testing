...
void vldcb7in0_v_u64_golden(uint64_t *base,uint32_t imm,uint64_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb7in0_v_u64_golden(exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb7in0_v_u64(base,8);
