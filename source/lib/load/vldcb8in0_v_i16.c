...
void vldcb8in0_v_i16_golden(int16_t *base,uint32_t imm,int16_t exp_result[][ELE_NUM]) {
...
int main(void) {
    ...
    //Get golden result
    vldcb8in0_v_i16_golden(exp_base,exp_imm,exp_result);

    //Get Intrinsic result
    result = vldcb8in0_v_i16(base,8);
