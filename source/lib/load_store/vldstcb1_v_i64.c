...
void vldstcb1_v_i64_golden(int64_t *base,int64_t*index,int64_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vldstcb1_v_i64_golden(exp_base, exp_index, exp_result);

    //Get Intrinsic result
    tmp_result = vgldcb1_v_i64(exp_base,index);
    ...
    vstcb1in0_v_i64(base, tmp_result, NORMAL);
    tmp2_result = vldcb1in0_v_i64(base, NORMAL);
    vsstcb1_v_i64(base2, index, tmp2_result);
    result = vgldcb1_v_i64(base2,index);
