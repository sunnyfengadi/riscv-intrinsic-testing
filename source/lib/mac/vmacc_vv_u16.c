...
void vmacc_vv_u16_golden(uint16_t *a,uint16_t *b,uint16_t *c,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vmacc_vv_u16_golden(exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vmacc_vv_u16(a,b,c);
