...
void vnmsac_vv_u32_m_golden(bool16_t mask,uint32_t *a,uint32_t *b,uint32_t *c,uint32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vnmsac_vv_u32_m_golden(exp_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vnmsac_vv_u32_m(mask,a,b,c);
