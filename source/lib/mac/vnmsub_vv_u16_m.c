...
void vnmsub_vv_u16_m_golden(bool32_t mask,uint16_t *a,uint16_t *b,uint16_t *c,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vnmsub_vv_u16_m_golden(exp_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vnmsub_vv_u16_m(mask,a,b,c);
