...
void vsnmsacq_vv_i32_m_golden(bool16_t mask,int32_t *a,int32_t *b,int32_t *c,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsnmsacq_vv_i32_m_golden(exp_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vsnmsacq_vv_i32_m(mask,a,b,c);
