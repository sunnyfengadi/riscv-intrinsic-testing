...
void vwmacc_vv_u16_golden(uint32_t *a,uint16_t *b,uint16_t *c,uint32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vwmacc_vv_u16_golden(exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vwmacc_vv_u16(a,b,c);
