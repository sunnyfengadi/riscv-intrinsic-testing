...
void vwnmsac_vv_i16_golden(int32_t *a,int16_t *b,int16_t *c,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vwnmsac_vv_i16_golden(exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vwnmsac_vv_i16(a,b,c);
