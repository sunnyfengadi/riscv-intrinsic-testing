...
void vwnmsub_vv_u32_golden(uint64_t *a,uint32_t *b,uint32_t *c,uint64_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vwnmsub_vv_u32_golden(exp_a,exp_b,exp_c,exp_accum,exp_result);

    //Get Intrinsic result
    result = vwnmsub_vv_u32(a,b,c,accum);
