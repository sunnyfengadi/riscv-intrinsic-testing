...
void vmv_v_i_i32_m_golden(uint64_t *mask,int32_t *maskoff,int32_t imm,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vmv_v_i_i32_m_golden(exp_mask,exp_maskoff,exp_imm,exp_result);

    //Get Intrinsic result
    result = vmv_v_i_i32_m(mask,maskoff,0);
