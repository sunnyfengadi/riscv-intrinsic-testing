...
void vmv_v_x_i64_m_golden(uint64_t *mask,int64_t *maskoff,int64_t a,int64_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vmv_v_x_i64_m_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vmv_v_x_i64_m(mask,maskoff,a);
