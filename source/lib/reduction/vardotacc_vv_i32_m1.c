...
void vardotacc_vv_i32_m1_golden(uint64_t *dst_mask,int32_t *a,int16_t *b,int16_t *c,int64_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vardotacc_vv_i32_m1_golden(exp_dst_mask,exp_a,exp_b,exp_c,exp_accum,exp_result);

    //Get Intrinsic result
    result = vardotacc_vv_i32_m1(dst_mask,a,b,c,accum);
