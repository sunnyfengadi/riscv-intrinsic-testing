...
void vardotacc_vv_u16_golden(uint32_t *a,int16_t *b,int16_t *c,uint32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vardotacc_vv_u16_golden(exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vardotacc_vv_u16(a,b,c);
