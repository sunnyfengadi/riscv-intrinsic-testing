...
void vardotacc_vv_u16_m1_golden(uint64_t *dst_mask,uint32_t *a,uint16_t *b,uint16_t *c,uint32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vardotacc_vv_u16_m1_golden(exp_dst_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vardotacc_vv_u16_m1(dst_mask,a,b,c);
