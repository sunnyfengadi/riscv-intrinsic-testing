...
void vrdotp_vv_i16_m1_golden(bool32_t mask,int16_t *a,int16_t *b,int16_t *c,int16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vrdotp_vv_i16_m1_golden(exp_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vrdotp_vv_i16_m1(mask,a,b,c);
