...
void vrdotp_vv_i32_m_golden(uint64_t *mask[2][16],int32_t *a,int32_t *b,int32_t *c,int32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrdotp_vv_i32_m_golden(exp_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vrdotp_vv_i32_m(mask,a,b,c);
