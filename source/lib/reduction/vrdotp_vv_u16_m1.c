...
void vrdotp_vv_u16_m1_golden(uint64_t *mask,uint16_t *a,uint16_t *b,uint16_t *c,uint16_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrdotp_vv_u16_m1_golden(exp_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vrdotp_vv_u16_m1(mask,a,b,c);
