...
void vrdotp_vv_u32_m1_golden(uint64_t *mask,uint32_t *a,uint32_t *b,uint32_t *c,uint32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrdotp_vv_u32_m1_golden(exp_mask,exp_a,exp_b,exp_c,exp_result);

    //Get Intrinsic result
    result = vrdotp_vv_u32_m1(mask,a,b,c);
