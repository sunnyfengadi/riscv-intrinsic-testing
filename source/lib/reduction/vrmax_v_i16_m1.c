...
void vrmax_v_i16_m1_golden(uint64_t *mask,int16_t *maskoff,int16_t *a,int16_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrmax_v_i16_m1_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vrmax_v_i16_m1(mask,maskoff,a);
