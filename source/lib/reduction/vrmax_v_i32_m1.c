...
void vrmax_v_i32_m1_golden(uint64_t *mask,int32_t *maskoff,int32_t *a,int32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrmax_v_i32_m1_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vrmax_v_i32_m1(mask,maskoff,a);
