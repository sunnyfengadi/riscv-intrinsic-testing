...
void vrmin_v_u32_m1_golden(uint64_t *mask,uint32_t *maskoff,uint32_t *a,uint32_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrmin_v_u32_m1_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vrmin_v_u32_m1(mask,maskoff,a);
