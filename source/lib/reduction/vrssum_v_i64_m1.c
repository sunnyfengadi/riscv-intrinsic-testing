...
void vrssum_v_i64_m1_golden(uint64_t *mask,int64_t *maskoff,int64_t *a,int64_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrssum_v_i64_m1_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vrssum_v_i64_m1(mask,maskoff,a);
