...
void vrsum_v_u16_m_golden(uint64_t *mask[2][32],uint16_t *maskoff,uint16_t *a,uint16_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrsum_v_u16_m_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vrsum_v_u16_m(mask,maskoff,a);
