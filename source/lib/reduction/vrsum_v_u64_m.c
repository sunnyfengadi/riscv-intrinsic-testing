...
void vrsum_v_u64_m_golden(uint64_t *mask[2][8],uint64_t *maskoff,uint64_t *a,uint64_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vrsum_v_u64_m_golden(exp_mask,exp_maskoff,exp_a,exp_result);

    //Get Intrinsic result
    result = vrsum_v_u64_m(mask,maskoff,a);
