...
void vsardotaccq_vv_i32_golden(int64_t *a,int32_t *b,int32_t *c,int64_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsardotaccq_vv_i32_golden(exp_a,exp_b,exp_c,exp_accum,exp_result);

    //Get Intrinsic result
    result = vsardotaccq_vv_i32(a,b,c,accum);
