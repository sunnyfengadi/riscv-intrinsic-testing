...
void vsardotaccq_vv_i32_m_golden(uint64_t *src_mask,uint64_t *dst_mask,int64_t *a,int32_t *b,int32_t *c,int64_t *exp_result) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsardotaccq_vv_i32_m_golden(exp_src_mask,exp_dst_mask,exp_a,exp_b,exp_c,exp_accum,exp_result);

    //Get Intrinsic result
    result = vsardotaccq_vv_i32_m(src_mask,dst_mask,a,b,c,accum);
