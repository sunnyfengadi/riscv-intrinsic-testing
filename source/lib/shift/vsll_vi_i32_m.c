...
void vsll_vi_i32_m_golden(uint64_t *mask,int32_t *maskoff,int32_t *a,uint32_t imm,int32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsll_vi_i32_m_golden(exp_mask,exp_maskoff,exp_a,exp_imm,exp_result);

    //Get Intrinsic result
    result = vsll_vi_i32_m(mask,maskoff,a,0);
