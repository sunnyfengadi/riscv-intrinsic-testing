...
void vsrl_vi_u16_m_golden(uint64_t *mask,uint16_t *maskoff,uint16_t *a,uint32_t imm,uint16_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsrl_vi_u16_m_golden(exp_mask,exp_maskoff,exp_a,exp_imm,exp_result);

    //Get Intrinsic result
    result = vsrl_vi_u16_m(mask,maskoff,a,0);
