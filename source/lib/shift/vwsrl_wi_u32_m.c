...
void vwsrl_wi_u32_m_golden(uint64_t *mask,uint32_t *maskoff,uint32_t *a,uint32_t imm,uint32_t *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vwsrl_wi_u32_m_golden(exp_mask,exp_maskoff,exp_a,exp_imm,exp_result);

    //Get Intrinsic result
    result = vwsrl_wi_u32_m(mask,maskoff,a,0);
