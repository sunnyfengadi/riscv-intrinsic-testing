...
void vsstcb1_v_i64_golden(int64_t base[],int64_t *index,int64_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb1_v_i64_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb1_v_i64(base,index,value);
