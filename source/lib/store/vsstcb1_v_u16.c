...
void vsstcb1_v_u16_golden(uint16_t base[],int16_t *index,uint16_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb1_v_u16_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb1_v_u16(base,index,value);
