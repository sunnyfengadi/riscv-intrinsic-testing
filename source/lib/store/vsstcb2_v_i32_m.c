...
void vsstcb2_v_i32_m_golden(bool16_t mask,int32_t base[],int32_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb2_v_i32_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb2_v_i32_m(mask,base,value);
