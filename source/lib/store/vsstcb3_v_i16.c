...
void vsstcb3_v_i16_golden(int16_t *base,int16_t *index,int16_t value[3][32],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb3_v_i16_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb3_v_i16(base,index,value);
