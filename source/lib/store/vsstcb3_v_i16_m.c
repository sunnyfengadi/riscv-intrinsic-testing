...
void vsstcb3_v_i16_m_golden(uint64_t *mask,int16_t *base,int16_t value[3][32],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb3_v_i16_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb3_v_i16_m(mask,base,value);
