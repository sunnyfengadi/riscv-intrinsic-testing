...
void vsstcb3_v_u32_golden(uint32_t *base,int32_t *index,uint32_t value[3][16],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb3_v_u32_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb3_v_u32(base,index,value);
