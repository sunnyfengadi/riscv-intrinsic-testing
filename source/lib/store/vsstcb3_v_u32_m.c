...
void vsstcb3_v_u32_m_golden(uint64_t *mask,uint32_t *base,uint32_t value[3][16],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb3_v_u32_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb3_v_u32_m(mask,base,value);
