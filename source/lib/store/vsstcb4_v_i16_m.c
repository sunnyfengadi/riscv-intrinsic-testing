...
void vsstcb4_v_i16_m_golden(bool32_t mask,int16_t base[],int16_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb4_v_i16_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb4_v_i16_m(mask,base,value);
