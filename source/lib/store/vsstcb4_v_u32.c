...
void vsstcb4_v_u32_golden(uint32_t base[],int32_t *index,uint32_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb4_v_u32_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb4_v_u32(base,index,value);
