...
void vsstcb4_v_u32_m_golden(bool16_t mask,uint32_t base[],uint32_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb4_v_u32_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb4_v_u32_m(mask,base,value);
