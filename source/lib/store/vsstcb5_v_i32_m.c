...
void vsstcb5_v_i32_m_golden(uint64_t *mask,int32_t *base,int32_t value[5][16],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb5_v_i32_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb5_v_i32_m(mask,base,value);
