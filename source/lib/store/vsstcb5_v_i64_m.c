...
void vsstcb5_v_i64_m_golden(uint64_t *mask,int64_t *base,int64_t value[5][8],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb5_v_i64_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb5_v_i64_m(mask,base,value);
