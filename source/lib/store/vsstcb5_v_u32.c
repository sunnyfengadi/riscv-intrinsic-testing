...
void vsstcb5_v_u32_golden(uint32_t *base,int32_t *index,uint32_t value[5][16],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb5_v_u32_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb5_v_u32(base,index,value);
