...
void vsstcb6_v_u16_m_golden(bool32_t mask,uint16_t base[],uint16_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb6_v_u16_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb6_v_u16_m(mask,base,value);
