...
void vsstcb7_v_i64_m_golden(bool8_t mask,int64_t base[],int64_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb7_v_i64_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb7_v_i64_m(mask,base,value);
