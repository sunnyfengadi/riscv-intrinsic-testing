...
void vsstcb7_v_u16_golden(uint16_t *base,int16_t *index,uint16_t value[7][32],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb7_v_u16_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb7_v_u16(base,index,value);
