...
void vsstcb7_v_u16_m_golden(uint64_t *mask,uint16_t *base,uint16_t value[7][32],) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vsstcb7_v_u16_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb7_v_u16_m(mask,base,value);
