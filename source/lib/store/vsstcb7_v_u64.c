...
void vsstcb7_v_u64_golden(uint64_t base[],int64_t *index,uint64_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb7_v_u64_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb7_v_u64(base,index,value);
