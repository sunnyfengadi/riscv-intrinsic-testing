...
void vsstcb8_v_i32_golden(int32_t base[],int32_t *index,int32_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb8_v_i32_golden(exp_base,exp_index,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb8_v_i32(base,index,value);
