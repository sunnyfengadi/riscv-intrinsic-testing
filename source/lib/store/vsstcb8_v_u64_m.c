...
void vsstcb8_v_u64_m_golden(bool8_t mask,uint64_t base[],uint64_t *value,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vsstcb8_v_u64_m_golden(exp_mask,exp_base,exp_value,exp_result);

    //Get Intrinsic result
    vsstcb8_v_u64_m(mask,base,value);
