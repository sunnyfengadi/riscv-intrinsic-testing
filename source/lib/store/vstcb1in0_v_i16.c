...
void vstcb1in0_v_i16_golden(int16_t base[],int16_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb1in0_v_i16_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb1in0_v_i16(base,value,0);
