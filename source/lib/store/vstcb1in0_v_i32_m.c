...
void vstcb1in0_v_i32_m_golden(bool16_t mask,int32_t base[],int32_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb1in0_v_i32_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);
