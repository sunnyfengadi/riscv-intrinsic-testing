...
void vstcb1in0_v_i64_m_golden(bool8_t mask,int64_t base[],int64_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb1in0_v_i64_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb1in0_v_i64_m(mask,base,value,0);
