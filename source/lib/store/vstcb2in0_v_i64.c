...
void vstcb2in0_v_i64_golden(int64_t base[],int64_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb2in0_v_i64_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb2in0_v_i64(base,value,0);
