...
void vstcb3in0_v_i16_golden(int16_t *base,int16_t value[3][32],uint32_t imm,) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vstcb3in0_v_i16_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb3in0_v_i16(base,value,0);
