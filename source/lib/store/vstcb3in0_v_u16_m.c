...
void vstcb3in0_v_u16_m_golden(uint64_t *mask,uint16_t *base,uint16_t value[3][32],uint32_t imm,) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vstcb3in0_v_u16_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb3in0_v_u16_m(mask,base,value,0);
