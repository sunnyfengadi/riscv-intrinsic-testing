...
void vstcb3in0_v_u32_golden(uint32_t *base,uint32_t value[3][16],uint32_t imm,) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vstcb3in0_v_u32_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb3in0_v_u32(base,value,0);
