...
void vstcb3in0_v_u64_m_golden(bool8_t mask,uint64_t base[],uint64_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb3in0_v_u64_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb3in0_v_u64_m(mask,base,value,0);
