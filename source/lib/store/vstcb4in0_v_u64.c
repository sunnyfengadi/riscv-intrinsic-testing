...
void vstcb4in0_v_u64_golden(uint64_t base[],uint64_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb4in0_v_u64_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb4in0_v_u64(base,value,0);
