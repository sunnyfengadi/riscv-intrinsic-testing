...
void vstcb5in0_v_i32_m_golden(uint64_t *mask,int32_t *base,int32_t value[5][16],uint32_t imm,) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vstcb5in0_v_i32_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb5in0_v_i32_m(mask,base,value,0);
