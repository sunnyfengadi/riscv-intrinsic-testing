...
void vstcb5in0_v_u64_golden(uint64_t *base,uint64_t value[5][8],uint32_t imm,) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vstcb5in0_v_u64_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb5in0_v_u64(base,value,0);
