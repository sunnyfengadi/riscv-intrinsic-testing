...
void vstcb5in0_v_u64_m_golden(uint64_t *mask,uint64_t *base,uint64_t value[5][8],uint32_t imm,) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vstcb5in0_v_u64_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb5in0_v_u64_m(mask,base,value,0);
