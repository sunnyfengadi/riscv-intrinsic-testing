...
void vstcb6in0_v_u16_golden(uint16_t base[],uint16_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb6in0_v_u16_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb6in0_v_u16(base,value,0);
