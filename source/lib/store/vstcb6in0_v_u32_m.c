...
void vstcb6in0_v_u32_m_golden(bool16_t mask,uint32_t base[],uint32_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb6in0_v_u32_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb6in0_v_u32_m(mask,base,value,0);
