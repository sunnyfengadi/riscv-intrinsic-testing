...
void vstcb7in0_v_i32_golden(int32_t base[],int32_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb7in0_v_i32_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb7in0_v_i32(base,value,0);
