...
void vstcb7in0_v_u16_golden(uint16_t *base,uint16_t value[7][32],uint32_t imm,) {
Operator Line --- TODO
}
...
int main(void) {
    ...
    //Get golden result
    vstcb7in0_v_u16_golden(exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb7in0_v_u16(base,value,0);
