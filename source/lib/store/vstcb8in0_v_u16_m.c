...
void vstcb8in0_v_u16_m_golden(bool32_t mask,uint16_t base[],uint16_t *value,uint32_t imm,void *exp_result) {
...
int main(void) {
    ...
    //Get golden result
    vstcb8in0_v_u16_m_golden(exp_mask,exp_base,exp_value,exp_imm,exp_result);

    //Get Intrinsic result
    vstcb8in0_v_u16_m(mask,base,value,0);
